...
describe('TodoListApplication', () => {
    ...
    it('includes Todos in query result', async () => {
        ...
        testlab_1.expect(response.body[0]).to.deepEqual({
    ...
    it('exploded filter conditions work', async () => {
        const list = await helpers_1.givenTodoListInstance(todoListRepo);
        await helpers_1.givenTodoInstance(todoRepo, { title: 'todo1', todoListId: list.id });
        await helpers_1.givenTodoInstance(todoRepo, { title: 'todo2', todoListId: list.id });
        await helpers_1.givenTodoInstance(todoRepo, { title: 'todo3', todoListId: list.id });
